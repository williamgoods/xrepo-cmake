...
function(_detect_toolchain)
	...
	# message(warning "xrepo: cmake_c_compiler or cmake_cxx_compiler is set but no known toolchain exists. using system default toolchain.")
        message("xrepo: cmake_c_compiler or cmake_cxx_compiler is set but no known toolchain exists. using system default toolchain.")
    endif()
endfunction()
...
macro(_xrepo_fetch_json)
    ...
    if(DEFINED links)
        ...
        set(${package_name}_CMAKE_LINK_LIBS ${${package_name}_LINK_LIBRARIES} PARENT_SCOPE)
        # message(STATUS "?????xrepo: ${package_name}_LINK_LIBRARIES is ${boost_CMAKE_LINK_LIBS}")
        # set_property(GLOBAL PROPERTY ${package_name}_CMAKE_LINK_LIBS ${${package_name}_LINK_LIBRARIES})
        # get_property(links GLOBAL PROPERTY ${package_name}_CMAKE_LINK_LIBS)
        # message(STATUS "?????xrepo: ${package_name}_LINK_LIBRARIES ${links}")
    else()
